    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-xbound-the-first-framework-for-join-size-lower-bounds-is-now-on-arxiv-this-is-a-collaboration-with-microsoft-gsl",
          title: 'xBound, the first framework for join size lower bounds is now on arXiv!...',
          description: "",
          section: "News",},{id: "news-mihail-stoian-is-presenting-his-paper-on-the-runtime-analysis-of-weighted-algorithmic-problems-compared-to-their-unweighted-counterparts-e-g-travelling-salesman-max-cut-etc-at-stacs-symposium-on-theoretical-aspects-of-computer-science-check-out-the-paper-and-blog-post",
          title: 'Mihail Stoian is presenting his paper on the runtime analysis of weighted algorithmic...',
          description: "",
